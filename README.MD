...
<ol>
    <li>Microsoft Presidio (Open Source)</li>
    <li>AWS Comprehend (Requires AWS Account)</li>
    <li>Azure PII Detection Cognitive Skill (Requires Azure Account)</li>
    <li>PII Codex Custom Analyzer (Open Source)</li>
</ol>
...
## Attributions
This project benefited greatly from a number of PII research works like that from Milne et. al (2018), Schwartz and Solove (2012), [insert the rest]. A special thanks to all the software modules, open source projects, and frameworks that made the setup and organization of this project much easier like Poetry, Microsoft Presidio, and spaCy.
